...
function! airline#themes#onedark#refresh()
  ...
  let s:N1 = [ '#22262d', '#98C379', s:term_black, s:term_green ]
  let s:N2 = [ '#ABB2BF', '#22262d', s:term_white, s:term_black ]
  let s:N3 = [ '#e5c07b', '#22262d', s:term_yellow, '' ]
